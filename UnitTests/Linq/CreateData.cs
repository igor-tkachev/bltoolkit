		...
		static void RunScript(string configString, string divider, string name)
		{
			...
			using (var db = new TestDbManager(configString))
			{
				...
				new SqlQuery<LinqDataTypes>().Insert(db, new[]
				{
					...
					new LinqDataTypes { ID =  6, MoneyValue =  6.51m, DateTimeValue = new DateTime(2009, 9, 22, 9, 19, 29,  90), BoolValue = false, GuidValue = new Guid("8d3c5d1d-47db-4730-9fe7-968f6228a4c0") },
