...
namespace Data.Linq
{
	...
	public class SubQuery : TestBase
	{
		...
		{
			ForEachProvider(
				new[] { ProviderName.Access, ProviderName.DB2, "Oracle", ProviderName.OracleManaged, "DevartOracle", "Sql2000", ProviderName.MySql, ProviderName.Sybase, ProviderName.Informix },
				db => AreEqual(
					from p1 in
						from p2 in Parent
