...
namespace Data.Linq
{
	...
	public class Types : TestBase
	{
		...
		public void DateTime22()
		{
			ForEachProvider(
				new[]
				{
					...
					ProviderName.Firebird, "Oracle", "DevartOracle", "OdpManaged", ProviderName.PostgreSQL, ProviderName.MySql, ProviderName.Sybase
				},
				db =>
				{
		...
		public void Unicode()
		{
			ForEachProvider(new[] { "DevartOracle", "OdpManaged", ProviderName.Informix, ProviderName.Firebird, ProviderName.Sybase }, db =>
			{
				try
				{
