...
namespace Data.Linq
{
	...
	public class DateTimeFunctions : TestBase
	{
		...
		{
			ForEachProvider(
				new[] { ProviderName.Informix, "Oracle", "DevartOracle", ProviderName.OracleManaged, ProviderName.PostgreSQL, ProviderName.MySql, ProviderName.SQLite, ProviderName.Access },
				db => AreEqual(
