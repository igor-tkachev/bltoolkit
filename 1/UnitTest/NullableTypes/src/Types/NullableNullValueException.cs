//
// NullableTypes.NullableNullValueException
// 
...
namespace NullableTypes {
    ...
    /// <summary>
    /// The exception that is thrown when the Value property of a 
    /// <see cref="NullableTypes"/> structure is set to null.
    /// </summary>
    /// <remarks>
    /// In order to avoid throwing this exception, you should always check the 
    /// IsNull property of the structure before accessing the Value property.
    /// </remarks>
    [sys.Serializable]
    public class NullableNullValueException
        : NullableTypeException, sysSrl.ISerializable
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NullableNullValueException"/> 
        ...
        /// </param>
        public NullableNullValueException(string message) : base (message) {}
        ...
        /// </param>
        public NullableNullValueException(string message, sys.Exception innerException) 
        ...
        protected NullableNullValueException(sysSrl.SerializationInfo info, sysSrl.StreamingContext context)
            : base(info, context) {}
