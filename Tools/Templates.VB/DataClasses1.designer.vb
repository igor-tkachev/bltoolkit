...
Namespace DataContext
    ...
    #End Region
		...
		Public Sub New()
			MyBase.New(Global.Templates.VB.My.MySettings.Default.NorthwindConnectionString, mappingSource)
			OnCreated
		End Sub
    ...
    #End Region
		...
		<Association(Name:="CustomerDemographic_CustomerCustomerDemo", Storage:="_CustomerDemographic", ThisKey:="CustomerTypeID", OtherKey:="CustomerTypeID", IsForeignKey:=true)>  _
		...
		<Association(Name:="Customer_CustomerCustomerDemo", Storage:="_Customer", ThisKey:="CustomerID", OtherKey:="CustomerID", IsForeignKey:=true)>  _
    ...
    #End Region
		...
		<Association(Name:="CustomerDemographic_CustomerCustomerDemo", Storage:="_CustomerCustomerDemos", ThisKey:="CustomerTypeID", OtherKey:="CustomerTypeID")>  _
    ...
    #End Region
		...
		<Association(Name:="Customer_CustomerCustomerDemo", Storage:="_CustomerCustomerDemos", ThisKey:="CustomerID", OtherKey:="CustomerID")>  _
		Public Property CustomerCustomerDemos() As EntitySet(Of CustomerCustomerDemo)
			Get
				Return Me._CustomerCustomerDemos
			End Get
    ...
    #End Region
		...
		<Association(Name:="Employee_EmployeeTerritory", Storage:="_EmployeeTerritories", ThisKey:="EmployeeID", OtherKey:="EmployeeID")>  _
		...
		<Association(Name:="Employee_Employee", Storage:="_Employee", ThisKey:="ReportsTo", OtherKey:="EmployeeID", IsForeignKey:=true)>  _
    ...
    #End Region
		...
		<Association(Name:="Employee_EmployeeTerritory", Storage:="_Employee", ThisKey:="EmployeeID", OtherKey:="EmployeeID", IsForeignKey:=true)>  _
		Public Property Employee() As Employee
			Get
				Return Me._Employee.Entity
			End Get
		...
		<Association(Name:="Territory_EmployeeTerritory", Storage:="_Territory", ThisKey:="TerritoryID", OtherKey:="TerritoryID", IsForeignKey:=true)>  _
    ...
    #End Region
		...
		<Association(Name:="Territory_EmployeeTerritory", Storage:="_EmployeeTerritories", ThisKey:="TerritoryID", OtherKey:="TerritoryID")>  _
		Public Property EmployeeTerritories() As EntitySet(Of EmployeeTerritory)
			Get
				Return Me._EmployeeTerritories
			End Get
