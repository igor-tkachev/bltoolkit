...
// 22-May-2003  Luca    Create       Added XML documentation
...
// 06-Dec-2003  Luca    Bug Fix      Replaced Xml Schema id "NullableInt32XmlSchema" with "NullableInt32"
//                                   because VSDesigner use it as type-name in the auto-generated WS client Proxy
// 06-Dec-2003  Luca    Bug Fix      Replaced Target Namespace for Xml Schema to avoid duplicate namespace with
...
namespace NullableTypes {
    ...
    /// </summary>
    [sys.Serializable]
    public struct NullableInt32 : INullable, sys.IComparable, sysXmlSrl.IXmlSerializable {
        #region Fields
        ...
        /// </remarks>
        public static readonly NullableInt32 MaxValue = new NullableInt32(sys.Int32.MaxValue);
        ...
        /// </remarks>
        public static readonly NullableInt32 MinValue = new NullableInt32(sys.Int32.MinValue);
        ...
        /// </summary>
        /// <remarks>
        /// Null field is a constant of the <see cref="NullableInt32"/> structure.
        /// </remarks>
        public static readonly NullableInt32 Null;
        ...
        /// </summary>
        /// <remarks>
        /// Zero field is a constant of the <see cref="NullableInt32"/> structure.
        /// </remarks>
        public static readonly NullableInt32 Zero = new NullableInt32(0);

        #endregion // Fields

        #region Constructors
        /// <summary>
        /// Initializes a new instance of the <see cref="NullableInt32"/> structure 
        /// using the specified integer value.
        /// </summary>
        /// <param name="value">
        /// An integer value to be stored in the <see cref="Value"/> property of the new 
        /// <see cref="NullableInt32"/> structure. 
        /// </param>
        ...
        /// </summary>
        /// <value>
        /// true if the <see cref="NullableInt32"/> structure is null, otherwise 
        /// false.
        /// </value>
        public bool IsNull {
            get { return !_notNull; }
        ...
        /// <summary>
        /// Compares this <see cref="NullableInt32"/> structure to a specified 
        ...
        /// </returns>
        /// <remarks>
        /// Any instance of <see cref="NullableInt32"/> , regardless of its 
        ...
        public int CompareTo(object value) {
            ...
            if (!(value is NullableInt32))
                throw new sys.ArgumentException(string.Format(sysGlb.CultureInfo.CurrentCulture, Locale.GetText("Value is not a {0}."), "NullableTypes.NullableInt32"));
            
            NullableInt32 iValue = (NullableInt32)value;
        ...
        sysXml.Schema.XmlSchema sysXmlSrl.IXmlSerializable.GetSchema() {
            ...
            //            targetNamespace="http://NullableTypes.SourceForge.Net/NullableInt32XMLSchema"
            //            xmlns="http://NullableTypes.SourceForge.Net/NullableInt32XMLSchema"
            //            elementFormDefault="qualified">
            //        <xs:element name="NullableInt32" type="xs:int" nillable="true" />
            //    </xs:schema>

            // Element: NullableInt32
            sysXmlScm.XmlSchemaElement rootElement = new sysXmlScm.XmlSchemaElement();
            rootElement.Name = "NullableInt32";
            rootElement.SchemaTypeName = 
                new sysXml.XmlQualifiedName("int", "http://www.w3.org/2001/XMLSchema");
            rootElement.IsNillable = true;

            // Xml Schema
            sysXmlScm.XmlSchema xsd = new sysXmlScm.XmlSchema();
            xsd.Id = "NullableInt32";
            xsd.Namespaces.Add("xs", "http://www.w3.org/2001/XMLSchema");
            xsd.TargetNamespace = "http://NullableTypes.SourceForge.Net/NullableInt32XMLSchema";
...
//            }
        ...
        void sysXmlSrl.IXmlSerializable.ReadXml(sysXml.XmlReader reader) {
            ...
            if (nilValue == null || nilValue == "false" || nilValue == "0") {
                _value = sysXml.XmlConvert.ToInt32(elementValue);
                _notNull = true;
            }
            else
                _notNull = false;
        ...
        #region Properties
        /// <summary>
        /// Gets the value of the <see cref="NullableInt32"/> structure. This 
        /// property is read-only
        /// </summary>
        /// <value>The value of the <see cref="NullableInt32"/> structure.</value>
        ...
        #region Equivalence
        /// <summary>
        /// Compares two <see cref="NullableInt32"/> structures to determine if 
        /// they are equivalent.
        /// </summary>
        /// <param name="value">The object to be compared. </param>
        /// <returns>
        /// true if object is an instance of <see cref="NullableInt32"/> and the 
        ...
        /// </summary>
        /// <param name="x">A <see cref="NullableInt32"/> structure.</param>
        /// <param name="y">A <see cref="NullableInt32"/> structure.</param>
        /// <returns>
        ...
        /// equivalent. If either instance of <see cref="NullableInt32"/> is 
        /// <see cref="Null"/>, the <see cref="NullableBoolean.Value"/> of the 
        /// <see cref="NullableBoolean"/> will be <see cref="NullableBoolean.Null"/>.
        /// </returns>
        public static NullableBoolean NotEquals(NullableInt32 x, NullableInt32 y) {
            return (x != y);
        }
        ...
        /// <see cref="NullableBoolean"/> will be <see cref="NullableBoolean.Null"/>.
        /// </returns>
        public static NullableBoolean Equals(NullableInt32 x, NullableInt32 y) {
            return (x == y);
        }


        /// <summary>
        /// Compares two instances of <see cref="NullableInt32"/> for equivalence.
        /// </summary>
        /// <param name="x">A <see cref="NullableInt32"/> structure.</param>
        /// <param name="y">A <see cref="NullableInt32"/> structure.</param>
        /// <returns>
        ...
        /// <see cref="NullableBoolean"/> will be <see cref="NullableBoolean.Null"/>.
        /// </returns>
        public static NullableBoolean operator == (NullableInt32 x, NullableInt32 y) {
        ...
        /// </summary>
        /// <returns>
        /// The enumerated constant, <see cref="TypeCode.NullableInt32"/>.
        /// </returns>
        public TypeCode GetTypeCode() {
            return TypeCode.NullableInt32;
        }

        /// <summary>
        /// Computes absolute value of the specified <see cref="NullableInt32"/> 
        /// structure.
        /// </summary>
        /// <param name="x">A <see cref="NullableInt32"/> structure.</param>
        /// <returns>
        /// <see cref="Null"/> if <see cref="NullableInt32"/> is 
        /// <see cref="Null"/> otherwise a <see cref="NullableInt32"/> structure 
        /// whose <see cref="Value"/> property contains the absolute value.
        /// </returns>
        public static NullableInt32 Abs(NullableInt32 x) {
            if (x.IsNull || x.Value > 0)
                return x;

            return new NullableInt32(sys.Math.Abs(x.Value));
        }


        /// <summary>
        /// Computes the sum of the two specified <see cref="NullableInt32"/> 
        /// structures.
        /// </summary>
        /// <param name="x">A <see cref="NullableInt32"/> structure.</param>
        /// <param name="y">A <see cref="NullableInt32"/> structure.</param>
        /// <returns>
        /// <see cref="Null"/> if either instance of <see cref="NullableInt32"/> is 
        /// <see cref="Null"/> otherwise a <see cref="NullableInt32"/> structure 
        ...
        /// </exception>
        public static NullableInt32 Add(NullableInt32 x, NullableInt32 y) {
            return (x + y);
        }


        /// <summary>
        /// Computes the bitwise AND of the two specified <see cref="NullableInt32"/> 
        /// structures.
        /// </summary>
        /// <param name="x">A <see cref="NullableInt32"/> structure.</param>
        /// <param name="y">A <see cref="NullableInt32"/> structure.</param>
        ...
        /// AND operation.
        /// </returns>
        public static NullableInt32 BitwiseAnd(NullableInt32 x, NullableInt32 y) {
            return (x & y);
        }
        
        
        /// <summary>
        /// Computes the bitwise OR of the two specified <see cref="NullableInt32"/> 
        /// structures.
        /// </summary>
        /// <param name="x">A <see cref="NullableInt32"/> structure.</param>
        /// <param name="y">A <see cref="NullableInt32"/> structure.</param>
        ...
        /// OR operation.
        /// </returns>
        public static NullableInt32 BitwiseOr(NullableInt32 x, NullableInt32 y) {
            return (x | y);
        }

        
        /// <summary>
        /// Divides its first <see cref="NullableInt32"/> operand by its second.
        /// </summary>
        /// <param name="x">A <see cref="NullableInt32"/> structure.</param>
        /// <param name="y">A <see cref="NullableInt32"/> structure.</param>
        /// <returns>
        ...
        /// not <see cref="Null"/>.
        /// </exception>
        public static NullableInt32 Divide(NullableInt32 x, NullableInt32 y) {
            return (x / y);
        }


        /// <summary>
        /// Compares two instances of <see cref="NullableInt32"/> structure to 
        ...
        /// <see cref="NullableInt32"/> is <see cref="NullableInt32.Null"/>, 
        ...
        /// </returns>
        public static NullableBoolean GreaterThan(NullableInt32 x, NullableInt32 y) {
            return (x > y);
        }
        ...
        /// </returns>
        public static NullableBoolean GreaterThanOrEqual(NullableInt32 x, NullableInt32 y) {
            return (x >= y);
        }
        ...
        /// than the second instance, otherwise <see cref="NullableBoolean.False"/>. 
        /// </returns>        
        public static NullableBoolean LessThan(NullableInt32 x, NullableInt32 y) {
            return (x < y);
        }
        ...
        /// <see cref="NullableBoolean.False"/>. 
        /// </returns>
        public static NullableBoolean LessThanOrEqual(NullableInt32 x, NullableInt32 y) {
            return (x <= y);
        }
        ...
        /// <see cref="NullableInt32"/> structures.
        /// </summary>
        /// <param name="x">A <see cref="NullableInt32"/> structure.</param>
        /// <param name="y">A <see cref="NullableInt32"/> structure.</param>
        /// <returns>
        ...
        /// </returns>
        public static NullableInt32 Mod(NullableInt32 x, NullableInt32 y) {
            return (x % y);
        }


        /// <summary>
        /// Computes the product of the two specified <see cref="NullableInt32"/> 
        /// structures.
        /// </summary>
        /// <param name="x">A <see cref="NullableInt32"/> structure.</param>
        /// <param name="y">A <see cref="NullableInt32"/> structure.</param>
        ...
        /// <see cref="System.Int32.MinValue"/> or greater than <see cref="System.Int32.MaxValue"/>.
        /// </exception>
        public static NullableInt32 Multiply(NullableInt32 x, NullableInt32 y) {
            return (x * y);
        }
        ...
        /// </returns>
        public static NullableInt32 OnesComplement(NullableInt32 x) {
            return ~x;
        }
        ...
        /// number to its <see cref="NullableInt32"/> equivalent.
        /// </summary>
        /// <param name="s">The <see cref="System.String"/> to be converted.</param>
        /// <returns>
        /// A <see cref="NullableInt32"/> structure containing the parsed value.
        /// </returns>
        ...
        public static NullableInt32 Parse(string s) {
            return new NullableInt32 (int.Parse(s, sysGlb.CultureInfo.CurrentCulture));
        }


        /// <summary>
        /// Computes the subtraction of the two specified <see cref="NullableInt32"/> 
        /// structures.
        /// </summary>
        /// <param name="x">A <see cref="NullableInt32"/> structure.</param>
        /// <param name="y">A <see cref="NullableInt32"/> structure.</param>
        ...
        /// <see cref="System.Int32.MinValue"/> or greater than <see cref="System.Int32.MaxValue"/>.
        /// </exception>
        public static NullableInt32 Subtract(NullableInt32 x, NullableInt32 y) {
            return (x - y);
        }
        ...
        /// XOR operation.
        /// </returns>
        public static NullableInt32 Xor(NullableInt32 x, NullableInt32 y) {
            return (x ^ y);
        }
        #endregion // Methods
        ...
        /// otherwise the one's complement of <paramref name="x"/>.
        /// </returns>
        public static NullableInt32 operator ~ (NullableInt32 x) {
            if (x.IsNull) 
                return NullableInt32.Null;

            return new NullableInt32 (~x.Value);
        }
        ...
        /// <summary>
        /// Negates the <see cref="Value"/> of the specified <see cref="NullableInt32"/>
        /// structure.
        /// </summary>
        /// <param name="x">A <see cref="NullableInt32"/> structure.</param>
        /// <returns>
        /// <see cref="Null"/> if <paramref name="x"/>  is <see cref="Null"/> 
        /// otherwise a <see cref="NullableInt32"/> structure containing the 
        /// negated value.
        /// </returns>
        /// <exception cref="System.OverflowException">
        ...
        /// <see cref="NullableInt32"/> structure constructed from the 
        /// <see cref="NullableBoolean.ByteValue"/> of <paramref name="x"/>.
        /// </returns>
        public static explicit operator NullableInt32(NullableBoolean x) {
            if (x.IsNull) 
                return Null;

            return new NullableInt32((int)x.ByteValue);
        }
        ...
        /// <see cref="System.Int32.MinValue"/> or greater than <see cref="System.Int32.MaxValue"/>.
        /// </exception>
        public static explicit operator NullableInt32(NullableDecimal x) {
            if (x.IsNull) 
                return Null;

            return new NullableInt32(sys.Decimal.ToInt32(x.Value));
        }
        ...
        /// <see cref="System.Int32.MinValue"/> or greater than <see cref="System.Int32.MaxValue"/>.
        /// </exception>
        public static explicit operator NullableInt32(NullableDouble x) {
            if (x.IsNull) 
                return NullableInt32.Null;

            checked { 
                return new NullableInt32((int)x.Value);
            }
        }


        /// <summary>
        /// Converts a <see cref="NullableInt32"/> to a <see cref="System.Int32"/>.
        /// </summary>
        /// <param name="x">A <see cref="NullableInt32"/> to convert.</param>
        /// <returns>
        /// A <see cref="System.Int32"/> set to the <see cref="Value"/> of the 
        /// <see cref="NullableInt32"/>.
        /// </returns>
        /// <exception cref="NullableNullValueException">
        /// <paramref name="x"/> is <see cref="Null"/>.
        /// </exception>
        public static explicit operator int(NullableInt32 x) {
            return x.Value;
        }
        ...
        /// <see cref="System.Int32.MinValue"/> or greater than <see cref="System.Int32.MaxValue"/>.
        /// </exception>
        public static explicit operator NullableInt32(NullableInt64 x) {
            if (x.IsNull) 
                return Null;
        ...
        /// </exception>
        public static explicit operator NullableInt32(NullableSingle x) {
            if (x.IsNull) 
                return NullableInt32.Null;
        ...
        /// <see cref="NullableInt32"/> structure containing the parsed value.
        /// </returns>
        /// <exception cref="System.FormatException">
        ...
        /// <see cref="System.Int32.MaxValue"/>.
        /// </exception>
        public static explicit operator NullableInt32(NullableString x) {
            if (x.IsNull) 
                return NullableInt32.Null;

            return NullableInt32.Parse(x.Value);
        }


        /// <summary>
        /// Converts the <see cref="System.Int32"/> parameter to a 
        /// <see cref="NullableInt32"/> structure.
        /// </summary>
        /// <param name="x">
        /// A <see cref="System.Int32"/> to be converted to a 
        /// <see cref="NullableInt32"/> structure. 
        /// </param>
        /// <returns>
        /// A new <see cref="NullableInt32"/> structure constructed from 
        /// <paramref name="x"/>.
        /// </returns>
        public static implicit operator NullableInt32(int x) {
        ...
        /// </returns>
        public static implicit operator NullableInt32(NullableByte x) {
            if (x.IsNull) 
                return NullableInt32.Null;
        ...
        /// </returns>
        public static implicit operator NullableInt32(NullableInt16 x) {
            if (x.IsNull) 
                return Null;
        ...
        #region Conversions
        /// <summary>
        /// Converts this <see cref="NullableInt32"/> instance to a 
        /// <see cref="NullableBoolean"/>.
        /// </summary>
        /// <returns>
        /// A <see cref="NullableBoolean"/> that is 
        /// <see cref="NullableBoolean.Null"/> if this <see cref="NullableInt32"/> is 
        /// <see cref="NullableInt32.Null"/>, <see cref="NullableBoolean.False"/> if
        /// this instance <see cref="NullableInt32.Value"/> is 
        /// <see cref="NullableInt32.Zero"/> otherwise 
        ...
        /// <see cref="NullableByte.Null"/> if this <see cref="NullableInt32"/> is 
        /// <see cref="NullableInt32.Null"/> otherwise a <see cref="NullableByte"/> 
        /// whose <see cref="NullableByte.Value"/> equals the 
        /// <see cref="NullableInt32.Value"/> of this instance.
        /// </returns>    
        /// <exception cref="System.OverflowException">
        /// This <see cref="NullableInt32"/> value is a number that is less than 
        ...
        /// <see cref="NullableDecimal.Null"/> if this <see cref="NullableInt32"/> is 
        /// <see cref="NullableInt32.Null"/> otherwise a <see cref="NullableDecimal"/> 
        ...
        /// <see cref="NullableDouble.Null"/> if this <see cref="NullableInt32"/> is 
        /// <see cref="NullableInt32.Null"/> otherwise a <see cref="NullableDouble"/> 
        ...
        /// <see cref="NullableInt16.Null"/> if this <see cref="NullableInt32"/> is 
        /// <see cref="NullableInt32.Null"/> otherwise a <see cref="NullableInt16"/> 
        ...
        /// <see cref="NullableInt64.Null"/> if this <see cref="NullableInt32"/> is 
        /// <see cref="NullableInt32.Null"/> otherwise a <see cref="NullableInt64"/> 
        ...
        /// <see cref="NullableSingle.Null"/> if this <see cref="NullableInt32"/> is 
        /// <see cref="NullableInt32.Null"/> otherwise a <see cref="NullableSingle"/> 
        ...
        /// <summary>
        /// Converts this <see cref="NullableInt32"/> structure to a 
        /// <see cref="NullableString"/> structure.
        /// </summary>
        /// <returns>
        /// <see cref="NullableString.Null"/> if this <see cref="NullableInt32"/>
        /// is <see cref="NullableInt32.Null"/> otherwise
        /// a new <see cref="NullableString"/> structure whose 
        /// <see cref="NullableString.Value"/> is the description of this 
        /// <see cref="NullableInt32"/> structure's <see cref="Value"/>.
        /// </returns>
        ...
        /// this <see cref="NullableInt32"/> structure's <see cref="Value"/>.
        /// </returns>
