...
namespace BLToolkit.Experimental
{
	public static class Convert<T,P>
	{
		...
		private static ConvertMethod GetInt16Converter()
		{
			...
			if (t == typeof(UInt32?))     return (ConvertMethod)(object)(Convert<Int16,UInt32?>.ConvertMethod)    (delegate(UInt32?     p) { return p.HasValue? Convert.ToInt16(p.Value) : (Int16)0; });
		...
		private static ConvertMethod GetSqlCharsConverter()
		{
			...
			if (t == typeof(SByte))       return (ConvertMethod)(object)(Convert<SqlChars,SByte>.ConvertMethod)      (delegate(SByte       p) { return new SqlChars(p.ToString().ToCharArray()); });
			if (t == typeof(Int16))       return (ConvertMethod)(object)(Convert<SqlChars,Int16>.ConvertMethod)      (delegate(Int16       p) { return new SqlChars(p.ToString().ToCharArray()); });
			if (t == typeof(Int32))       return (ConvertMethod)(object)(Convert<SqlChars,Int32>.ConvertMethod)      (delegate(Int32       p) { return new SqlChars(p.ToString().ToCharArray()); });
			if (t == typeof(Int64))       return (ConvertMethod)(object)(Convert<SqlChars,Int64>.ConvertMethod)      (delegate(Int64       p) { return new SqlChars(p.ToString().ToCharArray()); });

			if (t == typeof(Byte))        return (ConvertMethod)(object)(Convert<SqlChars,Byte>.ConvertMethod)       (delegate(Byte        p) { return new SqlChars(p.ToString().ToCharArray()); });
			if (t == typeof(UInt16))      return (ConvertMethod)(object)(Convert<SqlChars,UInt16>.ConvertMethod)     (delegate(UInt16      p) { return new SqlChars(p.ToString().ToCharArray()); });
			if (t == typeof(UInt32))      return (ConvertMethod)(object)(Convert<SqlChars,UInt32>.ConvertMethod)     (delegate(UInt32      p) { return new SqlChars(p.ToString().ToCharArray()); });
			if (t == typeof(UInt64))      return (ConvertMethod)(object)(Convert<SqlChars,UInt64>.ConvertMethod)     (delegate(UInt64      p) { return new SqlChars(p.ToString().ToCharArray()); });

			if (t == typeof(Char))        return (ConvertMethod)(object)(Convert<SqlChars,Char>.ConvertMethod)       (delegate(Char        p) { return new SqlChars(p.ToString().ToCharArray()); });
			if (t == typeof(Single))      return (ConvertMethod)(object)(Convert<SqlChars,Single>.ConvertMethod)     (delegate(Single      p) { return new SqlChars(p.ToString().ToCharArray()); });
			if (t == typeof(Double))      return (ConvertMethod)(object)(Convert<SqlChars,Double>.ConvertMethod)     (delegate(Double      p) { return new SqlChars(p.ToString().ToCharArray()); });

			if (t == typeof(Boolean))     return (ConvertMethod)(object)(Convert<SqlChars,Boolean>.ConvertMethod)    (delegate(Boolean     p) { return new SqlChars(p.ToString().ToCharArray()); });
			if (t == typeof(Decimal))     return (ConvertMethod)(object)(Convert<SqlChars,Decimal>.ConvertMethod)    (delegate(Decimal     p) { return new SqlChars(p.ToString().ToCharArray()); });
			if (t == typeof(DateTime))    return (ConvertMethod)(object)(Convert<SqlChars,DateTime>.ConvertMethod)   (delegate(DateTime    p) { return new SqlChars(p.ToString().ToCharArray()); });
			if (t == typeof(TimeSpan))    return (ConvertMethod)(object)(Convert<SqlChars,TimeSpan>.ConvertMethod)   (delegate(TimeSpan    p) { return new SqlChars(p.ToString().ToCharArray()); });
			if (t == typeof(Guid))        return (ConvertMethod)(object)(Convert<SqlChars,Guid>.ConvertMethod)       (delegate(Guid        p) { return new SqlChars(p.ToString().ToCharArray()); });
			...
			if (t == typeof(object))      return (ConvertMethod)(object)(Convert<SqlChars,object>.ConvertMethod)     (delegate(object      p) { return new SqlChars(p.ToString().ToCharArray()); });
